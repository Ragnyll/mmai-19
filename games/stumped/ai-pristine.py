...
class AI(BaseAI):
    ...
    def get_name(self):
        return "Hillary\'s Deleted Beavers I mean Emails"
    ...
    def basic_beaver_strat(self):
        """
        Turn one this beaver must move between food and branches then build a lodge
        """
        pass

    def fighter_beaver_strat(self):
        """
        These beavers must go choke out enemies at their lodges
        """
        pass

    def bulky_beaver_strat(self):
        """
        Good question
        """
        pass

    def hungry_beaver_strat(self):
        """
        only gather food with them
        """
        pass

    def swift_beaver_strat(self):
        """
        ???
        """
        pass

    def hotlady_beaver_strat(self):
        """
        just dont use them
        """
        pass

    def builder_beaver_strat(self):
        """
        spawn them first then build with them
        """
        pass
